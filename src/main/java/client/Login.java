...
public class Login extends JFrame {
    ...
    private void configComponents(){
        ...
        ImageIcon icon = new ImageIcon("src/main/logo-chat.png");
        ...
        jt_user.setBounds(120,120,275,40);
        jt_port.setBounds(120,170,275,40);
    }
            ...
            try {
                ...
                if(Utils.receiveMessage(connection).equals("SUCESS")) {
                    ...
                    JOptionPane.showMessageDialog(null, 
                        "Algum usuário já está conectado com esse apelido ou nesse host e porta, tente outra porta!");    
                }
            }   catch(IOException ex) {
                JOptionPane.showMessageDialog(null, "Erro ao conectar, verifique se o servidor está em execucao!");
            }
        });
    }
